...
export default function SessionCreatePage({ friends }: Props) {
    ...
    const [selectedFriendIdsState, setSelectedFriendIds] = useState<number[]>(
        [],
    );
    ...
    const selectedFriendIds = useMemo(
        () =>
            selectedFriendIdsState
                .filter((id) => allowedFriendIds.has(id))
                .slice(0, maxSelectable),
        [allowedFriendIds, maxSelectable, selectedFriendIdsState],
    );
    ...
    const remainingSlots = Math.max(
        maxSelectable - selectedFriendIds.length,
        0,
    );
                                ...
                                <>
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                        <div className="space-y-2">
                                            ...
                                            />
                                            <InputError
                                                message={errors['rules.base']}
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <Label htmlFor="rules_k">
                                                係数 (k)
                                            </Label>
                                            <Input
                                                id="rules_k"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <InputError
                                            message={errors['rules.rank_bonus']}
                                        />
                                    </div>
