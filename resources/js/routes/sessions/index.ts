...
* @see app/Http/Controllers/Sessions/SessionViewController.php:15
...
* @see app/Http/Controllers/Sessions/SessionController.php:24
* @route '/sessions'
*/
...
* @see app/Http/Controllers/Sessions/SessionController.php:59
...
* @see app/Http/Controllers/Sessions/SessionController.php:287
...
* @see app/Http/Controllers/Sessions/SessionJoinController.php:13
* @route '/sessions/join'
*/
